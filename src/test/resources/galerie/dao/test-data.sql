...
INSERT INTO Exposition(id, dateexpo, intitule, duree, galerie_id) VALUES (1, TO_DATE('2020/01/16', 'YYYY/MM/DD'), 'intituleExpo1', 11, 1);
INSERT INTO Exposition(id, dateexpo, intitule, duree, galerie_id) VALUES (2, TO_DATE('2020/06/15', 'YYYY/MM/DD'), 'intituleExpo2', 12, 2);
INSERT INTO Exposition(id, dateexpo, intitule, duree, galerie_id) VALUES (3, TO_DATE('2020/03/22', 'YYYY/MM/DD'), 'intituleExpo3', 13, 3);
INSERT INTO Exposition(id, dateexpo, intitule, duree, galerie_id) VALUES (4, TO_DATE('2020/03/22', 'YYYY/MM/DD'), 'intituleExpo4', 10, 1);
...
INSERT INTO Transaction(id, prixVente, dateTransac, client_id, lieuVente_id, tableau_id) VALUES (1, 123, TO_DATE('2020/01/17', 'YYYY/MM/DD'), 1,1,1);
INSERT INTO Transaction(id, prixVente, dateTransac, client_id, lieuVente_id, tableau_id) VALUES (2, 7, TO_DATE('2020/01/18', 'YYYY/MM/DD'), 1,1,2);